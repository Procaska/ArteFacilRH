...
class PreviewWindow(QDialog):
    ...
    def criar_interface(self):
        ...
        titulo = QLabel("Conferir aniversários")
        ...
        for numero_arte, grupo in enumerate(self.artes,start=1):

            card = QFrame()
            card.setObjectName("card_arte")
            ...
            # TÍTULO DA ARTE
            titulo_arte = QLabel(f"ARTE {numero_arte}")
            titulo_arte.setObjectName("titulo_arte")

            layout_card.addWidget(titulo_arte)
            ...
            for posicao, (_, funcionario) in enumerate(
                ...
                linha = QFrame()
                linha.setObjectName("linha_funcionario")

                layout_linha = QHBoxLayout(linha)
                layout_linha.setContentsMargins(12, 8, 12, 8)

                numero = QLabel(f"{posicao:02d}")
                ...
                data.setAlignment(Qt.AlignmentFlag.AlignRight)

                layout_linha.addWidget(numero)
                layout_linha.addWidget(nome)
                layout_linha.addStretch()
                layout_linha.addWidget(data)
